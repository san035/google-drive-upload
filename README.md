...
- ✅ **Простая загрузка файлов** на Google Drive
- ✅ **Управление копиями** - автоматическое удаление старых версий
- ✅ **Проверка квоты** - контроль свободного места перед загрузкой
- ✅ **Поддержка нескольких аккаунтов** Google Drive
- ✅ **Настройка через YAML** конфигурацию
- ✅ **OAuth2 авторизация** с автоматическим обновлением токенов

## Установка и использование

### Как пакет в вашем проекте
...
├── pkg/
│   ├── googledrive/                  # Основной пакет
│   │   ├── client.go                 # Клиент Google Drive
│   │   ├── quota.go                  # Работа с квотой
│   │   └── token.go                  # OAuth2 токены
│   └── config/                       # Конфигурация
│       └── config.go                 # Загрузка YAML конфигов
└── examples/                         # Примеры использования
    └── basic-usage/                  # Базовые примеры
        ├── main.go                   # Примеры кода
